...
export default function Component({ users = [], list = {}, task = {}, onTaskUpdate = () => { }, isOpen = false, onClose = () => { } }) {
        ...
        >
          <DialogHeader>
            <DialogTitle className="flex justify-between items-center text-2xl font-bold mb-4">
              <div className='flex gap-3 items-center justify-start'>
                ...
                {isEditingName ? (
                  <Input
                    ...
                    className="text-2xl bg-neutral-900 w-fit border-neutral-700 text-white placeholder-neutral-400 focus:ring-neutral-500 focus:border-neutral-500"
                    autoFocus
                  />
                ) : (
                  <div
              ...
              <motion.button
                onClick={cycleStatus}
                className={`px-3 py-1 rounded-full text-xs font-semibold capitalize transition-all duration-200 ${statusColors[tempStatus]}`}
              ...
              <ScrollArea className="h-72 rounded-md pr-4">
                ...
                {isEditingDescription ? (
                  <Textarea
                    ...
                    className="border-neutral-700 text-white placeholder-neutral-400 focus:ring-neutral-500 focus:border-neutral-500 min-h-64 max-w-full"
                    autoFocus
                  />
                ) : (
                  <div
                ...
                <div>
                  ...
                  {isEditingStartDate ? (
                    <Input
                      ...
                      className="bg-neutral-900 border-neutral-700 text-white placeholder-neutral-400 focus:ring-neutral-500 focus:border-neutral-500"
                      autoFocus
                    />
                  ) : (
                    <div
                      className="relative group cursor-pointer bg-neutral-900 border border-neutral-700 rounded-md p-2 flex items-center"
            ...
            <div>
              <div>
                ...
                <Select onValueChange={handleUserChange}>
                  ...
                  {users.find((user) => user.id === task.user_id)?.name || "Select a user"}
                  </SelectTrigger>
                  <SelectContent>
                    {users.map((user) => (
